    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.totyu.apps.ws.tzsb.TzsbWsService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.totyu.apps.ws.tzsb.TzsbWsService.class.getResource(".");
    ...
    public TzsbWebService getTzsbWsServicePort() {
        return super.getPort(new QName("http://ws.web.totyu.com", "TzsbWsServicePort"), TzsbWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "TzsbWsServicePort")
    public TzsbWebService getTzsbWsServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.web.totyu.com", "TzsbWsServicePort"), TzsbWebService.class, features);
    }
