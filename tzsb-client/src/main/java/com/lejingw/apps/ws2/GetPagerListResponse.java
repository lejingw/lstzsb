 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://ws2.apps.lejingw.com}pager" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetPagerListResponse {
     ...
     * 
     */
    public List<Pager> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Pager>();
        }
        return this._return;
    }
