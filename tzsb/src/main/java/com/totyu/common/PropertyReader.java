...
public class PropertyReader {
    ...
    private static Map<String,String>   systemParamerMap = new HashMap<String,String>();
     ...
     * @param systemParameterValue
     */
    public static final void putSystemParameterToSystemParamerMap(String systemParameterName, String systemParameterValue){
        
        if(StringUtil.isBlank(systemParameterName)){
            return ;
        }
        
        systemParamerMap.put(systemParameterName, systemParameterValue);
        
    }
    
    public static final String getSystemParameterToSystemParamerMap(String systemParameterName){
        
        if(StringUtil.isBlank(systemParameterName)){
            return null;
        }
        
        return systemParamerMap.get(systemParameterName);
     ...
     * @return
     */
    public static Map<String, String> getSystemParamerMap() {
        return systemParamerMap;
    }

    /**
     * 设子系统MAP对象
     * @param systemParamerMap
     */
    public static void setSystemParamerMap(Map<String, String> systemParamerMap) {
        PropertyReader.systemParamerMap = systemParamerMap;
    }
