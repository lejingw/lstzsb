...
class ExcelColumnCheckRule {
	...
	public ExcelColumnCheckRule(int sheetIndex, int columnIndex, boolean allowEmpty,
	...
	public ExcelColumnCheckRule(int sheetIndex, int columnIndex,
