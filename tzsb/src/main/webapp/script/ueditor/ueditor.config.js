...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:ctxPath + "/uploadServlet?type=1"  //图片上传提交地址
        ,imagePath:ctxPath                           //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //附件上传配置区
    	,fileUrl:ctxPath + "/uploadServlet?type=2"   //附件上传提交地址
        ,filePath:ctxPath                            //附件修正地址，同imagePath
        ...
        //图片在线管理配置区
        ,imageManagerUrl:ctxPath + "/uploadServlet?type=3"    //图片在线管理的处理地址
        ,imageManagerPath:location.protocol + "//" + location.hostname + ":" + location.port + ctxPath  //图片修正地址，同imagePath
...
//        }
        ...
        //,initialContent:'欢迎使用!'    //初始化编辑器的内容,也可以通过textarea/script给值，看官网例子
